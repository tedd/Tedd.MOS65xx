...
src/Tedd.MOS65xx.GUI        Windows desktop front-end (WPF): memory viewer/editor, key binding editor, audio visualizer
...
* **WPF** (`src/Tedd.MOS65xx.GUI`): attach D64/T64/PRG/CRT, autostart, screenshots, freeze + memory viewer/editor
  with cycle/instruction/frame stepping, key binding editor (Tools menu) where you pick the keys that make up the
  joysticks, audio visualizer window.
